...
let Transformer = {
  proivateData: {
    ...
    solarTerm: ["소한", "대한", "입춘", "우수", "경칩", "춘분", "청명", "곡우", "입하", "소만", "망종", "하지", "소서", "대서", "입추", "처서", "백로", "추분", "한로", "상강", "입동", "소설", "대설", "동지"],
    sFtv: ["0101 신정", "0114 다이어리데이", "0214 발렌타인데이", "0301 삼일절", "0308 국제여성의날", "0314 화이트데이", "0401 만우절", "0405 식목일", "0414 블랙데이", "0419 4.19혁명", "0501 근로자의날",
    "0505 어린이날", "0514 로즈데이", "0515 스승의날", "0518 5.18민주화운동기념일", "0521 부부의날", "0606 현충일", "0614 키스데이", "0625 6.25한국전쟁", "0714 실버데이", "0717 제헌절", "0814 그린데이",
    "0815 광복절", "0914 포토데이", "1001 국군의날", "1003 개천절", "1009 한글날", "1014 와인데이", "1114 무비데이", "1214 허그데이", "1225 성탄절"],
    lFtv: ["0101 구정", "0115 정월대보름", "0505 단오", "0707 칠석", "0815 추석"],
    lunarDate: {
      year: 1,
      month: 0,
      day: 1,
  ...
  methods: {
    solar2lunar(d) {
      ...
      return {
        'IDayCn': (yun.isYunMonth ? "윤" : '음') + (yun.month + 1) + "." + yun.day
      }
    },
